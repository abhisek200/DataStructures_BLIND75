package com.leetcode.Practice;// Java program to implement LRU Least Recently Used) using
...
class _2_2_LRUCache {
    ...
    public static void main(String[] args) {
        ...
        _2_2_LRUCache cache = new _2_2_LRUCache(2);
        cache.put(1, 1);
        cache.put(2, 2);
